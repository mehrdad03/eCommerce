                                    ...
                                    <td class="text-end">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" wire:click="editColor('{{$color->id}}')">Edit info</a>
                                                <button type="button" class="dropdown-item text-danger" wire:click="deleteConfirm({{$color->id}})">Delete</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
