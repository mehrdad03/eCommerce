        ...
        <div class="card-body">
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name"><a class="itemside" href="#">
                            <div class="left"><img class="img-sm img-thumbnail" src="assets/imgs/items/1.jpg" alt="Item"></div>
                            <div class="info">
                    ...
                    <div class="col-lg-2 col-sm-2 col-4 col-action text-end"><a class="btn btn-sm font-sm rounded btn-brand mr-5" href="#"><i class="material-icons md-edit"></i> Edit</a><a class="btn btn-sm font-sm btn-light rounded" href="#"><i class="material-icons md-delete_forever"></i> Delete</a></div>
                </div>
                <!-- row .//-->
                <!-- itemlist  .//-->
            </article>
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name"><a class="itemside" href="#">
                            <div class="left"><img class="img-sm img-thumbnail" src="assets/imgs/items/2.jpg" alt="Item"></div>
                            <div class="info">
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name"><a class="itemside" href="#">
                            <div class="left"><img class="img-sm img-thumbnail" src="assets/imgs/items/3.jpg" alt="Item"></div>
                            <div class="info">
                                <h6 class="mb-0">Lace mini dress with faux leather</h6>
                            </div></a></div>
                    <div class="col-lg-2 col-sm-2 col-4 col-price"><span>$76.99</span></div>
                    <div class="col-lg-2 col-sm-2 col-4 col-status"><span class="badge rounded-pill alert-warning">Archived</span></div>
                    <div class="col-lg-1 col-sm-2 col-4 col-date"><span>02.11.2022</span></div>
                    <div class="col-lg-2 col-sm-2 col-4 col-action text-end"><a class="btn btn-sm font-sm rounded btn-brand mr-5" href="#"><i class="material-icons md-edit"></i> Edit</a><a class="btn btn-sm font-sm btn-light rounded" href="#"><i class="material-icons md-delete_forever"></i> Delete</a></div>
                </div>
                <!-- row .//-->
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name"><a class="itemside" href="#">
                            <div class="left"><img class="img-sm img-thumbnail" src="assets/imgs/items/4.jpg" alt="Item"></div>
                            <div class="info">
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-2 col-sm-2 col-4 col-price"><span>$76.99</span></div>
                    <div class="col-lg-2 col-sm-2 col-4 col-status"><span class="badge rounded-pill alert-danger">Disabled</span></div>
                    <div class="col-lg-1 col-sm-2 col-4 col-date"><span>02.11.2022</span></div>
                    <div class="col-lg-2 col-sm-2 col-4 col-action text-end"><a class="btn btn-sm font-sm rounded btn-brand mr-5" href="#"><i class="material-icons md-edit"></i> Edit</a><a class="btn btn-sm font-sm btn-light rounded" href="#"><i class="material-icons md-delete_forever"></i> Delete</a></div>
                </div>
                <!-- row .//-->
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name"><a class="itemside" href="#">
                            <div class="left"><img class="img-sm img-thumbnail" src="assets/imgs/items/5.jpg" alt="Item"></div>
                            <div class="info">
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name"><a class="itemside" href="#">
                            <div class="left"><img class="img-sm img-thumbnail" src="assets/imgs/items/6.jpg" alt="Item"></div>
                            <div class="info">
