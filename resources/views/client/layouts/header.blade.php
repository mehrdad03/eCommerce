                    ...
                    <div class="d-inline-block box-dropdown-cart"><span class="font-lg icon-list icon-cart"><span>Cart</span><span class="number-item font-xs">2</span></span>
                        <div class="dropdown-cart">
                            <div class="item-cart mb-20">
                                ...
                                <div class="cart-info"><a class="font-sm-bold color-brand-3" href="shop-single-product.html">MSI Optix G272 27" Full HD LED Gaming LCD Monitor</a>
                            ...
                            <div class="item-cart mb-20">
                                ...
                                <div class="cart-info"><a class="font-sm-bold color-brand-3" href="shop-single-product-2.html">MSI Optix G272 27" Full HD LED Gaming LCD Monitor</a>
                                    <p><span class="color-brand-2 font-sm-bold">1 x $2856.4</span></p>
                                </div>
                            </div>
