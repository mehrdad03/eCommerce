            ...
            <div class="row">
                    ...
                    <div class="gallery-image">
                        <div class="galleries">
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider" dir="rtl">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-9 text-start text-sm-end"><a class="ml-20 d-inline-block" href="shop-wishlist.html"><span class="btn btn-wishlist ml-5 opacity-100 transform-none"></span><span class="font-md color-gray-900">Add to Wish list</span></a><a href="shop-compare.html"><span class="btn btn-compare ml-5 opacity-100 transform-none"></span><span class="font-md color-gray-900">Add to Compare</span></a></div>
                    </div>
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="d-inline-block">
                                            <div class="share-link"><span class="font-md-bold color-brand-3 ml-15">Share</span><a class="facebook hover-up" href="#"></a><a class="printest hover-up" href="#"></a><a class="twitter hover-up" href="#"></a><a class="instagram hover-up" href="#"></a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
